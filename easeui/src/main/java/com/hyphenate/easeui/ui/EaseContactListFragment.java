...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    protected void getContactList() {
        ...
        Map<String, EaseUser> userMap = EaseContactUtil.getInstance().getContactList();

        synchronized (userMap) {
            Iterator<Entry<String, EaseUser>> iterator = userMap.entrySet().iterator();
